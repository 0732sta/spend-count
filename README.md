...
<table>
  ...
  <tr>
    <th>The analytic diagram based on year and should have color inside month which the subtotal expenses by month. instead the total expenses to the user.</th>
    <th>This is user output</th>
  </tr>
  <tr>
